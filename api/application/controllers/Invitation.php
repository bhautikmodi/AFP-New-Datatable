				...
				if($result) {
					...
					<tbody>
						...
						<tr>
							...
							<p>Please <a href="http://qaassessment.uatbyopeneyes.com/invitation">click here<a>  to complete your registration using the invitation code listed below.
				...
				$this->db->select('Value');
					...
					<tbody>
						...
						<tr>
							...
							<p>Please <a href="http://afpnew.uatbyopeneyes.com/invitation">click here<a>  to complete your registration using the invitation code listed below.
							 You will be required to set up a profile with a username and password allowing you to use the tool at your convenience.</p>
